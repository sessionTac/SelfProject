                    ...
                    <el-form  class="search-form search-form-normal" label-width="110px" ref="form"
                        ...
                        <el-form-item :label="$t('pageTable.OrderInfoOrderDate')" prop="orderDate">
                            <el-date-picker
                              ...
                              :placeholder="$t('pageTable.choose')">
                            </el-date-picker>
                            <template slot="error" slot-scope="scope">
                                <div style="float: right;margin-right: 100px;font-size: 10px;color: red">{{scope.error}}</div>
                            </template>
                        ...
                        <el-form-item :label="$t('pageTable.OrderInfoOrderType')" prop="orderType">
                        ...
                        <el-form-item :label="$t('pageTable.OrderInfoDateFlag')" prop="dateFlag">
                            <el-radio v-model="form.dateFlag" label="year">{{$t('searchFrom.year')}}</el-radio>
                            <el-radio v-model="form.dateFlag" label="month">{{$t('searchFrom.month')}}</el-radio>
                            <el-radio v-model="form.dateFlag" label="week">{{$t('searchFrom.week')}}</el-radio>
                        </el-form-item>
...
<script>
    ...
    export default {
        ...
        computed: {
            title: function () {
                let entityName = this.$t('searchFrom.orderPlan')
        ...
        data() {
            return {
                ...
                rules: {
                    orderCode: [
                        {required: true, message:  this.$t('Tips.checkOrderCode'), trigger: 'blur'},
                    ...
                    orderUnit: [
                        {required: true, message: this.$t('Tips.checkOrderUnit'), trigger: 'change'}
                    ],
                    orderType: [
                        {required: true, message:this.$t('Tips.checkOrderType'), trigger: 'change'}
                    ],
                    orderStatus: [
                        {required: true, message: this.$t('Tips.checkOrderStatus'), trigger: 'change'}
                    ],
                },
            }
        },
