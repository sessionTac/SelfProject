  ...
  <div style="display: flex;flex-direction: column;height: 100%">
    <div class="el-header">
      <el-form :inline="true" class="search-form search-form-normal" size="mini" ref="searchForm" :model="search_keys">
        ...
        <el-form-item label="件数（托盘件数）">
          <el-input placeholder="件数（托盘件数）" v-model="search_keys.matterEnDec" class="search-form-item-input"></el-input>
        </el-form-item>
        ...
        <el-form-item label="数量">
          <el-input placeholder="数量" v-model="search_keys.scalerUnit" class="search-form-item-input"></el-input>
        </el-form-item>
    ...
    >
      ...
      <el-table-column prop="scalerRela" align="center" label="数量"  />
