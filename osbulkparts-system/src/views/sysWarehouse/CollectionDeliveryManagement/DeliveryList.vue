<template>
  <div style="display: flex;flex-direction: column;height: 100%">
    <div class="el-header">
      <el-form :inline="true" class="search-form search-form-normal" size="mini" ref="searchForm" :model="search_keys">
        ...
        <el-form-item label="箱型箱量">
          <el-input placeholder="箱型箱量" v-model="search_keys.matterEnDec" class="search-form-item-input"></el-input>
        </el-form-item>
        <el-form-item label="集装箱号">
          <el-input placeholder="集装箱号" v-model="search_keys.matterEnDec" class="search-form-item-input"></el-input>
        </el-form-item>
        ...
        <el-form-item label="分提单号">
          <el-input placeholder="分提单号" v-model="search_keys.scalerUnit" class="search-form-item-input"></el-input>
        </el-form-item>
        <el-form-item label="单价">
          <el-input placeholder="单价" v-model="search_keys.scalerUnit" class="search-form-item-input"></el-input>
        </el-form-item>
        <el-form-item label="HS编码">
          <el-input placeholder="HS编码" v-model="search_keys.scalerUnit" class="search-form-item-input"></el-input>
        </el-form-item>
        <el-form-item label="发货港">
          <el-input placeholder="发货港" v-model="search_keys.scalerUnit" class="search-form-item-input"></el-input>
        </el-form-item>
        <el-form-item label="目的港">
          <el-input placeholder="目的港" v-model="search_keys.scalerUnit" class="search-form-item-input"></el-input>
        </el-form-item>
        <el-form-item label="皮重">
          <el-input placeholder="皮重" v-model="search_keys.scalerUnit" class="search-form-item-input"></el-input>
        </el-form-item>
        <el-form-item label="VGM">
          <el-input placeholder="VGM" v-model="search_keys.scalerUnit" class="search-form-item-input"></el-input>
        </el-form-item>
        <el-form-item label="运费">
          <el-input placeholder="运费" v-model="search_keys.scalerUnit" class="search-form-item-input"></el-input>
        </el-form-item>
    ...
    >
      ...
      <el-table-column prop="matterEnDec"  :show-overflow-tooltip="true" align="center" label="箱型箱量"  />
      <el-table-column prop="matterEnDec"  :show-overflow-tooltip="true" align="center" label="集装箱号"  />
      ...
      <el-table-column prop="currency" align="center" label="分提单号"  />
      <el-table-column prop="currency" align="center" label="单价"  />
      <el-table-column prop="currency" align="center" label="HS编码"  />
      <el-table-column prop="currency" align="center" label="发货港"  />
      <el-table-column prop="currency" align="center" label="目的港"  />
      <el-table-column prop="currency" align="center" label="皮重"  />
      <el-table-column prop="currency" align="center" label="VGM"  />
      <el-table-column prop="currency" align="center" label="运费"  />
